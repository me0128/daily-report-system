...
public class EmployeeAction extends ActionBase {
	...
	public void index() throws ServletException, IOException {
		...
		putRequestScope(AttributeConst.EMP_COUNT, employeeCount);//すべての従業員件数
	...
	public void entryNew() throws ServletException, IOException {
		...
		putRequestScope(AttributeConst.TOKEN, getTokenId());//CSRF対策用ﾄｰｸﾝ
	...
	public void show() throws ServletException, IOException {
		...
		if (ev == null || ev.getDeleteFlag() == AttributeConst.DEL_FLAG_TRUE.getIntegerValue()) {
			...
			//データ取得が出来なかった、または論理削除されている場合はエラー画面を表示
	...
	public void edit() throws ServletException, IOException {
		...
		putRequestScope(AttributeConst.TOKEN, getTokenId());//CSRF対策用ﾄｰｸﾝ
		putRequestScope(AttributeConst.EMPLOYEE, ev);//取得従業員データ
